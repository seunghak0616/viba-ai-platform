    ...
    try {
      ...
      const response = await fetch('/api/ai/chat', {
        ...
        body: JSON.stringify({
          ...
          message: newMessage,
          session_id: localStorage.getItem(`ai_session_${selectedAgent.id}`) || undefined,
        }),
      });
      ...
      if (response.ok) {
        ...
        // 세션 ID 저장
        if (data.session_id) {
          localStorage.setItem(`ai_session_${selectedAgent.id}`, data.session_id);
        }
      } else {
